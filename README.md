...
Currently supports 28 languages — full plugin depth for TypeScript, Python, C#, Dart, GDScript, Go, and Rust; generic linter + tree-sitter support for Ruby, Java, Kotlin, and 17 more.
